...
test
  1
  eq
  (null_denominator (create_ratio (big_int_of_int 1) (big_int_of_int (-2))), false)
...
;;
test 1 eq_int (sign_ratio (create_ratio (big_int_of_int (-2)) (big_int_of_int (-3))), 1)

;;
test 2 eq_int (sign_ratio (create_ratio (big_int_of_int 2) (big_int_of_int (-3))), -1)
...
;;
test 1 eq (is_integer_ratio (create_ratio (big_int_of_int 2) (big_int_of_int (-1))), true)

;;
test 2 eq (is_integer_ratio (create_ratio (big_int_of_int 2) (big_int_of_int 3)), false)
...
in
test 11 eq_big_int (numerator_ratio r, big_int_of_string "1040259735682744320")
&& test 12 eq_big_int (denominator_ratio r, big_int_of_string "2169804593037312000")
...
&& test 4 eq_big_int (add_big_int bi1 bi2, big_int_of_string "1040259735682744320")
...
test
  1
  eq_big_int
  (integer_ratio (create_ratio (big_int_of_int 5) (big_int_of_int 3)), big_int_of_int 1)
...
test
  3
  eq_big_int
  (integer_ratio (create_ratio (big_int_of_int 3) (big_int_of_int 2)), big_int_of_int 1)
...
test
  1
  eq_big_int
  (floor_ratio (create_ratio (big_int_of_int 5) (big_int_of_int 3)), big_int_of_int 1)
...
test
  3
  eq_big_int
  (floor_ratio (create_ratio (big_int_of_int 3) (big_int_of_int 2)), big_int_of_int 1)
...
test
  1
  eq_big_int
  (round_ratio (create_ratio (big_int_of_int 5) (big_int_of_int 3)), big_int_of_int 2)
...
test
  3
  eq_big_int
  (round_ratio (create_ratio (big_int_of_int 3) (big_int_of_int 2)), big_int_of_int 2)
...
test
  1
  eq_big_int
  (ceiling_ratio (create_ratio (big_int_of_int 5) (big_int_of_int 3)), big_int_of_int 2)
...
test
  3
  eq_big_int
  (ceiling_ratio (create_ratio (big_int_of_int 3) (big_int_of_int 2)), big_int_of_int 2)
...
test
  5
  eq_big_int
  (ceiling_ratio (create_ratio (big_int_of_int 4) (big_int_of_int 2)), big_int_of_int 2)
...
test
  4
  neq_ratio
  (create_ratio (big_int_of_int 1) zero_big_int, create_ratio zero_big_int zero_big_int)

;;
test
  5
  eq_ratio
  (create_ratio zero_big_int zero_big_int, create_ratio zero_big_int zero_big_int)
...
;;
test 1 eq_int (int_of_ratio (create_ratio (big_int_of_int 4) (big_int_of_int 2)), 2)

;;
test
  2
  eq_int
  ( int_of_ratio (create_ratio (big_int_of_int biggest_int) (big_int_of_int 1))
  , biggest_int )
...
failwith_test
  4
  int_of_ratio
  (create_ratio (succ_big_int (big_int_of_int biggest_int)) (big_int_of_int 1))
  (Failure "integer argument required")
...
;;
test 1 eq_ratio (ratio_of_int 3, create_ratio (big_int_of_int 3) (big_int_of_int 1))

;;
test
  2
  eq_ratio
  (ratio_of_nat (nat_of_int 2), create_ratio (big_int_of_int 2) (big_int_of_int 1))
...
test
  1
  eq_string
  (string_of_ratio (create_ratio (big_int_of_int 43) (big_int_of_int 35)), "43/35")

;;
test
  2
  eq_string
  (string_of_ratio (create_ratio (big_int_of_int 42) (big_int_of_int 0)), "1/0")
...
test
  3
  eq_string
  (string_of_ratio (create_ratio (big_int_of_int 42) (big_int_of_int 35)), "42/35")
...
test
  4
  eq_string
  (string_of_ratio (create_ratio (big_int_of_int 42) (big_int_of_int 35)), "6/5")
...
test
  1
  eq_ratio
  (ratio_of_string "123/3456", create_ratio (big_int_of_int 123) (big_int_of_int 3456))
...
;;
let s = approx_ratio_fix 5 (create_ratio (big_int_of_int 2) (big_int_of_int 3)) in
...
test
  2
  eq_string
  (approx_ratio_fix 5 (create_ratio (big_int_of_int 20) (big_int_of_int 3)), "+6.66667")

;;
test
  3
  eq_string
  (approx_ratio_fix 5 (create_ratio (big_int_of_int 2) (big_int_of_int 30)), "+0.06667")
...
test
  ...
  ( approx_ratio_fix
      5
      (create_ratio (big_int_of_string "999996") (big_int_of_string "1000000"))
  , "+1.00000" )
...
test
  ...
  ( approx_ratio_fix
      5
      (create_ratio (big_int_of_string "299996") (big_int_of_string "100000"))
  , "+2.99996" )
...
test
  ...
  ( approx_ratio_fix
      5
      (create_ratio (big_int_of_string "2999996") (big_int_of_string "1000000"))
  , "+3.00000" )
...
test
  8
  eq_string
  ( approx_ratio_fix 5 (create_ratio (big_int_of_int 29996) (big_int_of_string "100000"))
  , "+0.29996" )
...
test
  9
  eq_string
  (approx_ratio_fix 5 (create_ratio (big_int_of_int 0) (big_int_of_int 1)), "+0")
...
test
  ...
  ( approx_ratio_fix
      8
      (create_ratio (big_int_of_int 9603) (big_int_of_string "100000000000"))
  , "+0.00000010" )
...
test
  13
  eq_string
  (approx_ratio_fix 1 (create_ratio (big_int_of_int 94) (big_int_of_int 1000)), "+0.1")

;;
test
  14
  eq_string
  (approx_ratio_fix 1 (create_ratio (big_int_of_int 49) (big_int_of_int 1000)), "+0.0")
...
test
  1
  eq_string
  (approx_ratio_exp 5 (create_ratio (big_int_of_int 2) (big_int_of_int 3)), "+0.66667e0")

;;
test
  2
  eq_string
  (approx_ratio_exp 5 (create_ratio (big_int_of_int 20) (big_int_of_int 3)), "+0.66667e1")

;;
test
  3
  eq_string
  ( approx_ratio_exp 5 (create_ratio (big_int_of_int 2) (big_int_of_int 30))
  , "+0.66667e-1" )
...
test
  6
  eq_string
  ( approx_ratio_exp 5 (create_ratio (big_int_of_int 29996) (big_int_of_string "100000"))
  , "+0.29996e0" )
...
test
  7
  eq_string
  (approx_ratio_exp 5 (create_ratio (big_int_of_int 0) (big_int_of_int 1)), "+0.00000e0")
