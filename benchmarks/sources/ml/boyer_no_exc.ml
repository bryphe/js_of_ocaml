...
let apply_subst alist term =
  let rec as_rec = function
    | Var v -> ( match get_binding v alist with Some t -> t | None -> term)
...
let _ =
  ...
  add
    (CProp ("equal", [CProp ("gt", [CVar 23; CVar 24]); CProp ("lt", [CVar 24; CVar 23])]));
  add
    (CProp ("equal", [CProp ("le", [CVar 23; CVar 24]); CProp ("ge", [CVar 24; CVar 23])]));
  add
    (CProp ("equal", [CProp ("ge", [CVar 23; CVar 24]); CProp ("le", [CVar 24; CVar 23])]));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [CProp ("fact_", [CVar 8]); CProp ("fact_loop", [CVar 8; CProp ("one", [])])] ));
  add
    (CProp
       ( "equal"
  ...
  add (CProp ("equal", [CProp ("difference", [CVar 23; CVar 23]); CProp ("zero", [])]));
  add
    (CProp
       ( "equal"
       , [ CProp
  ...
  add
    (CProp
       ( "equal"
       , [ CProp ("equal", [CProp ("zero", []); CProp ("difference", [CVar 23; CVar 24])])
  ...
  add
    (CProp
       ...
       , [ CProp ("reverse", [CProp ("append", [CVar 0; CVar 1])])
         ; CProp ("append", [CProp ("reverse", [CVar 1]); CProp ("reverse", [CVar 0])])
         ] ));
  add
    (CProp
       ( "equal"
       , [ CProp ("times", [CVar 23; CProp ("plus", [CVar 24; CVar 25])])
         ; CProp
             ( "plus"
             , [CProp ("times", [CVar 23; CVar 24]); CProp ("times", [CVar 23; CVar 25])]
             ) ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("exec", [CProp ("append", [CVar 23; CVar 24]); CVar 15; CVar 4])
         ; CProp ("exec", [CVar 24; CProp ("exec", [CVar 23; CVar 15; CVar 4]); CVar 4])
         ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("member", [CVar 23; CProp ("append", [CVar 0; CVar 1])])
         ; CProp
             ( "or"
             , [CProp ("member", [CVar 23; CVar 0]); CProp ("member", [CVar 23; CVar 1])]
             ) ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [CProp ("length", [CProp ("reverse", [CVar 23])]); CProp ("length", [CVar 23])]
       ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [ CProp ("power_eval", [CProp ("big_plus", [CVar 11; CVar 8; CVar 1]); CVar 1])
  ...
  add
    (CProp
       ("equal", [CProp ("remainder", [CVar 24; CProp ("one", [])]); CProp ("zero", [])]));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ("equal", [CProp ("gcd", [CVar 23; CVar 24]); CProp ("gcd", [CVar 24; CVar 23])]));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("times", [CVar 23; CProp ("difference", [CVar 2; CVar 22])])
         ; CProp
             ( "difference"
             , [CProp ("times", [CVar 2; CVar 23]); CProp ("times", [CVar 22; CVar 23])]
             ) ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp
             ( "lt"
             , [CProp ("times", [CVar 23; CVar 25]); CProp ("times", [CVar 24; CVar 25])]
             )
         ; CProp
             ( "and"
  ...
  add
    (CProp
       ...
       , [ CProp
         ...
         ; CProp
             ("and", [CProp ("nlistp", [CVar 23]); CProp ("equal", [CVar 23; CVar 24])])
         ] ));
  add
    (CProp
       ( "equal"
       , [CProp ("listp", [CProp ("gother", [CVar 23])]); CProp ("listp", [CVar 23])] ));
  add
    (CProp
       ( "equal"
       , [ CProp ("samefringe", [CVar 23; CVar 24])
         ; CProp ("equal", [CProp ("flatten", [CVar 23]); CProp ("flatten", [CVar 24])])
         ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ( "equal"
       , [ CProp
             ("equal", [CProp ("greatest_factor", [CVar 23; CVar 24]); CProp ("one", [])])
  ...
  add
    (CProp
       ...
       , [ CProp ("times_list", [CProp ("append", [CVar 23; CVar 24])])
         ; CProp
             ("times", [CProp ("times_list", [CVar 23]); CProp ("times_list", [CVar 24])])
         ] ));
  add
    (CProp
       ( "equal"
       , [ CProp ("prime_list", [CProp ("append", [CVar 23; CVar 24])])
         ; CProp
             ("and", [CProp ("prime_list", [CVar 23]); CProp ("prime_list", [CVar 24])])
         ] ));
  add
    (CProp
       ( "equal"
                               ...
                               , [ CVar 2
                                 ; CProp
                                     ...
                                     , [ CVar 3
                                       ; CProp
                                           ( "cons"
                                           , [CVar 4; CProp ("cons", [CVar 5; CVar 6])]
                                           ) ] ) ] ) ] ) ] ) ] )
             ...
             , [ CProp ("lt", [CVar 23; CVar 24])
               ...
               ; CProp
                   ...
                   , [ CProp ("lt", [CVar 25; CVar 24])
                     ...
                     ; CProp
                         ("equal", [CProp ("fix", [CVar 23]); CProp ("fix", [CVar 25])])
                     ] ) ] ) ] ));
  add
    (CProp
       ( "equal"
  ...
  add
    (CProp
       ...
       , [ CProp ("quotient", [CProp ("times", [CVar 24; CVar 23]); CVar 24])
         ; CProp
             ( "if"
             , [CProp ("zerop", [CVar 24]); CProp ("zero", []); CProp ("fix", [CVar 23])]
             ) ] ));
  add
    (CProp
       ( "equal"
  ...
  ; Bind
      ...
      , cterm_to_term
          (CProp
             ...
             , [ CProp
                   ( "times"
                   , [CProp ("times", [CVar 0; CVar 1]); CProp ("plus", [CVar 2; CVar 3])]
                   ) ] )) )
  ; Bind
      ( 25
      , cterm_to_term
